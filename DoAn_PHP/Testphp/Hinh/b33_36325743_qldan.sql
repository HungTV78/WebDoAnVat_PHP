...
--
-- Máy chủ: sql212.byethost33.com
-- Thời gian đã tạo: Th6 03, 2024 lúc 01:15 PM
...
(8, 3, 1, 45000, 45000, 5),
(9, 3, 1, 45000, 45000, 8),
(10, 3, 1, 45000, 45000, 11),
(11, 3, 1, 45000, 45000, 12),
(12, 7, 1, 15000, 15000, 12),
(13, 3, 1, 45000, 45000, 13),
(14, 3, 1, 45000, 45000, 14),
(15, 4, 1, 55000, 55000, 14),
(16, 5, 1, 150000, 150000, 15),
(17, 3, 1, 45000, 45000, 17),
(18, 3, 1, 45000, 45000, 18),
(19, 3, 1, 45000, 45000, 20),
(20, 4, 1, 55000, 55000, 23),
(21, 4, 1, 55000, 55000, 25),
(22, 6, 1, 160000, 160000, 27),
(23, 4, 2, 55000, 110000, 35),
(24, 3, 1, 45000, 45000, 35),
(25, 3, 1, 45000, 45000, 37),
(26, 3, 1, 45000, 45000, 38),
(27, 3, 1, 45000, 45000, 40),
(28, 3, 1, 45000, 45000, 43),
(29, 3, 1, 45000, 45000, 44),
(30, 3, 1, 45000, 45000, 46),
(31, 3, 1, 45000, 45000, 47),
(32, 4, 1, 55000, 55000, 48);
...
INSERT INTO `giohang` (`magiohang`, `masp`, `mand`, `soluong`) VALUES
(0, 4, 3, 2);
...
INSERT INTO `hoadon` (`mahd`, `ngaylap`, `phuongthuc`, `tongcong`, `mand`, `makh`) VALUES
(1, '2024-05-18', 'Tiền Mặt', 70000, 1, 1),
(2, '2024-05-18', 'Tiền Mặt', 310000, 1, 2),
(3, '2024-05-18', 'Chuyển Khoản', 45000, 1, 3),
(44, '2024-06-03', 'Tiền mặt', 33750, 710, NULL),
(45, '2024-06-03', 'Tiền mặt', 0, 710, NULL),
(46, '2024-06-03', 'Tiền mặt', 33750, 710, NULL),
(47, '2024-06-03', 'Tiền mặt', 33750, 710, NULL),
(48, '2024-06-03', 'ATM', 55000, 908, NULL);
...
INSERT INTO `khachhang` (`makh`, `diemso`, `mand`) VALUES
(1, 50, 3),
(2, 25, 710),
(3, 0, 1713),
(4, NULL, 30),
...
(1, 'Trần Văn Tèo', '0123456789', 'TPHCM', '123@gmail.com', '1980-05-25', '2024-01-01', 1, 'admin', '123'),
(2, 'Nguyễn Văn A', '090912345', '123 Lê Trọng Tấn', 'nguyenvana@gmail.com', '1990-01-01', '2024-01-02', 1, 'username', 'password'),
(3, 'Trần Văn Tèo Em', '1234567891', 'TPHCM', '123234@gmail.com', '2022-10-12', NULL, 2, 'a1', '$2y$10$RbjFASOyeyiO5eyv2qYe.ua5L69Y5jn1fyvPleUJlGfkD.5n1ry72'),
(4, 'Shop Ăn Vặt', '0909090909', 'Long An', 'shopanvat@gmail.com', '2003-05-22', NULL, 1, 'admin123', '$2y$10$H/B9SnKgFL6xzrBaMj73Jeex4TOQRzY6v7/4aohLKfUVcUYvSZZ6m'),
(30, 'Thang1234567', '09122345', '123letrongtan', 'a@gmail.com', '2024-05-28', NULL, 2, 'a123', '$2y$10$cV9GCiQuyp8P12VcU.C4B.p15yAiMmqZep3vFgDewqCjcTMTD6dmm'),
(710, 'Nguyễn x', '0123457899', 'meo meo', 'ahihi@gmail.com', '2003-01-01', NULL, 2, 'sos', '$2y$10$2qtc45FWleSyHs75fM75OuNMOFgCDG9Li482kkntiwHV0Pne08c.i'),
(908, 'Lê Hưng', '0377498488', 'py', 'dammebongda29@gmail.com', '2024-06-26', NULL, 2, 'hungle78', '$2y$10$W1jlyTkkrzb1VsbWByarkeO.fiJFNkIplOBxV25Tz7sh5eM4kwCwi'),
(1712, 'Lê Hưng', '0377498488', 'py', 'admin@gmail.com', '2023-07-14', NULL, 1, 'lehung29', '$2y$10$o/1mTrg1RqspBvZddMeEl.jGnYu3GfVpVtxDjnlOZFASOMhIYszKe'),
(1713, 'Thang', '09122345', '123letrongtan', 'a@gmail.com', '2023-05-09', NULL, 2, 'a2', '$2y$10$jNjNavN6yosLdfowmbKi8.rzMVXnguNpDm/I.IcqbxVXANEVARTwy');
...
(3, 'Khô Lợn', 'khoheo.jpg', 'Còn hàng', 'Khô Heo bếp làm 6 năm nay khách nào ăn cũng biết từng cọng thịt gà thấm vị săn ngon chứ không bị bở đâu nhé.', 5, 45000, 1),
...
(12, 'Kẹo Đậu Phộng', 'keodau phong.jpg', 'Còn hàng', 'Kẹo đậu phộng lá me nội địa, hương vị rất đặc trưng.', 5, 15000, 5),
...
--
ALTER TABLE `chitiethoadon`
  MODIFY `macthd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `nguoidung`
  MODIFY `mand` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1715;
...
--
ALTER TABLE `khachhang`
  ADD CONSTRAINT `khachhang_ibfk_1` FOREIGN KEY (`mand`) REFERENCES `nguoidung` (`mand`);
